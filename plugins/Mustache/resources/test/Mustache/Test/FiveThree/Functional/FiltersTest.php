...
class Mustache_Test_FiveThree_Functional_FiltersTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getBrokenPipes()
    {
        return array(
            ...
            array('foo | bar | baz', array('foo' => 'FOO', 'bar' => function () {
                return 'BAR';
            })),
            array('foo | bar | baz', array('foo' => 'FOO', 'baz' => function () {
                return 'BAZ';
            })),
            array('foo | bar | baz', array('bar' => function () {
                return 'BAR';
            })),
            array('foo | bar | baz', array('baz' => function () {
                return 'BAZ';
            })),
            array('foo | bar.baz', array('foo' => 'FOO', 'bar' => function () {
                return 'BAR';
