...
class nodeStructure extends PHPDS_dependant
{
	 ...
	 * @param string $plugin Plugin, or delete node items by plugin which is always the folder the plugin lies in.
	 * @param boolean $delete_critical_only Checks if only critical node data needs to be deleted while ignoring data like permissions etc.
     *
     * @return boolean
	 */
