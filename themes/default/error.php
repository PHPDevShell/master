...
<div id="wrap">
    <div id="bg" class="container-fluid">
        ...
        <?php if (!empty($theme['message'])) {
            ...
            <?php if ($ignore >= 0) { ?>
                <p>The origin of the error is <em><strong>probably</strong></em> in file
                    <strong><em><?php echo $frame['file']?></em></strong> at line
                    <strong><?php echo $frame['line']?></strong></p>
            ...
            <p>All relative file paths are relative to the server root namely
                <em><?php echo $_SERVER['DOCUMENT_ROOT']; ?>/</em></p>
